/*! Copyright (C) Stillat, LLC. All Rights Reserved. */
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: {
    ...
    searchOptions: new _Data_Comments_searchOptions__WEBPACK_IMPORTED_MODULE_8__["default"](),
    commentRepo: new _Repositories_commentRepository__WEBPACK_IMPORTED_MODULE_4__["default"](),
    commentData: null
  },
  methods: {
    updateQueryWithPage: function updateQueryWithPage(pageNumber) {
    ...
    loadCommentData: function loadCommentData() {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    computedSize: function computedSize() {
      if (_Types_type__WEBPACK_IMPORTED_MODULE_2__["default"].hasValue(this.size)) {
        return this.size;
      }
...
var forceSmallSliderCutOff = 10;
var paginatorRangeAdjustment = 2;
var paginatorRangeSizeOffset = 6;
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  props: {
     ...
     */
    pageData: {
      type: _Data_Paged_common__WEBPACK_IMPORTED_MODULE_5__["PagedMetaData"],
      "default": null
    }
  },
  data: function data() {
  ...
  watch: {
    instancePerPage: function instancePerPage(val, oldVal) {
      if (oldVal > -1) {
  ...
  methods: {
    ...
    getWindowStart: function getWindowStart() {
      return _Types_common__WEBPACK_IMPORTED_MODULE_3__["Range"].get(1, this.visibleRangeWindow + paginatorRangeAdjustment);
    },
    getWindowEnd: function getWindowEnd() {
      return _Types_common__WEBPACK_IMPORTED_MODULE_3__["Range"].get(this.pageData.totalPages - (this.visibleRangeWindow + paginatorRangeAdjustment), this.pageData.totalPages);
    },
    getRangeStart: function getRangeStart() {
      return _Types_common__WEBPACK_IMPORTED_MODULE_3__["Range"].get(1, 2);
    },
    getRangeEnd: function getRangeEnd() {
      return _Types_common__WEBPACK_IMPORTED_MODULE_3__["Range"].get(this.pageData.totalPages - 1, this.pageData.totalPages);
    },
    getRangeAdjacent: function getRangeAdjacent() {
      return _Types_common__WEBPACK_IMPORTED_MODULE_3__["Range"].get(this.pageData.currentPage - this.rangeItemsPerSide, this.pageData.currentPage + this.rangeItemsPerSide);
    },
    //  endregion
    //  region Navigation Support
    hasPage: function hasPage(pageNumber) {
    ...
    shouldUseSmallSlider: function shouldUseSmallSlider() {
    ...
    shouldUseBeginningSlider: function shouldUseBeginningSlider() {
      return this.pageData.currentPage <= this.visibleRangeWindow;
    },
    shouldUseEndSlider: function shouldUseEndSlider() {
      return this.pageData.currentPage > this.pageData.totalPages - this.visibleRangeWindow;
    },
    updateVisibleRange: function updateVisibleRange(perSide) {
      this.visibleRangeWindow = perSide * paginatorRangeAdjustment;
    },
    makeRangeItem: function makeRangeItem(pageNumber) {
      var newItem = new _Data_Paged_common__WEBPACK_IMPORTED_MODULE_5__["RangeItem"]();
    ...
    makeRangeArray: function makeRangeArray(range) {
      var rangeItems = [];
    ...
    buildSeparatedRangeItems: function buildSeparatedRangeItems(ranges) {
      var rangeItems = [],
  ...
  computed: {
    hasMultiplePages: function hasMultiplePages() {
      if (this.pageData === null) {
        return false;
      }
    ...
    shouldDisplayPerPageSelection: function shouldDisplayPerPageSelection() {
    ...
    visibleRange: function visibleRange() {
      ...
      if (this.shouldUseSmallSlider()) {
        rangeItems = this.makeRangeArray(_Types_common__WEBPACK_IMPORTED_MODULE_3__["Range"].get(1, this.pageData.totalPages));
      } else if (this.shouldUseBeginningSlider()) {
        rangeItems = this.buildSeparatedRangeItems([this.getWindowStart(), this.getRangeEnd()]);
      } else if (this.shouldUseEndSlider()) {
        rangeItems = this.buildSeparatedRangeItems([this.getRangeStart(), this.getWindowEnd()]);
      } else {
        rangeItems = this.buildSeparatedRangeItems([this.getRangeStart(), this.getRangeAdjacent(), this.getRangeEnd()]);
      }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Translation_translator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../Translation/translator */ "./src/Translation/translator.js");
...
/***/ "./src/App/controlPanelApplication.js":
/*!********************************************!*\
  !*** ./src/App/controlPanelApplication.js ***!
  \********************************************/
/*! exports provided: default */
...
/* harmony import */ var _Statamic_controlPanel__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./../Statamic/controlPanel */ "./src/Statamic/controlPanel.js");
/* harmony import */ var _bootstrapper__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./bootstrapper */ "./src/App/bootstrapper.js");
...
var ControlPanelApplication = /*#__PURE__*/function () {
  function ControlPanelApplication() {
    _classCallCheck(this, ControlPanelApplication);

    this.cpHooks = _hooks__WEBPACK_IMPORTED_MODULE_1__["controlPanelHooks"];
    this.controlPanel = new _Statamic_controlPanel__WEBPACK_IMPORTED_MODULE_2__["default"]();
  }

  _createClass(ControlPanelApplication, [{
    key: "boot",
    value: function boot() {
      this.runCpHooks();
      _bootstrapper__WEBPACK_IMPORTED_MODULE_3__["default"].bootstrapApplications();
    }
  }, {
    key: "runCpHooks",
    value: function runCpHooks() {
      var pathName = window.location.pathname;

      for (var i = 0; i < this.cpHooks.length; i += 1) {
...
/* harmony default export */ __webpack_exports__["default"] = (ControlPanelApplication);
...
/* harmony import */ var _controlPanelApplication__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./controlPanelApplication */ "./src/App/controlPanelApplication.js");
/* harmony import */ var _bootstrapper__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./bootstrapper */ "./src/App/bootstrapper.js");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
App.Bootstrapper = _bootstrapper__WEBPACK_IMPORTED_MODULE_1__["default"];
App.ControlPanelApplication = _controlPanelApplication__WEBPACK_IMPORTED_MODULE_0__["default"];
...
/* harmony import */ var _environment__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./environment */ "./src/Config/environment.js");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var Comment = /*#__PURE__*/function () {
  ...
  _createClass(Comment, [{
    ...
    value: function fromApiObject(apiObject) {
      ...
      comment.id = _Types_common__WEBPACK_IMPORTED_MODULE_1__["Type"].withDefault(apiObject[Comment.ApiId], null);
      ...
      comment.ancestors = _Types_common__WEBPACK_IMPORTED_MODULE_1__["Type"].withDefault(apiObject[Comment.ApiAncestors], []);
      comment.children = _Types_common__WEBPACK_IMPORTED_MODULE_1__["Type"].withDefault(apiObject[Comment.ApiChildren], []);
      comment.commentDate = _Types_common__WEBPACK_IMPORTED_MODULE_1__["Type"].withDefault(apiObject[Comment.ApiCommentDate], null);
      comment.commentDateFormatted = _Types_common__WEBPACK_IMPORTED_MODULE_1__["Type"].withDefault(apiObject[Comment.ApiCommentDateFormatted], null);
      comment.replies = _Types_common__WEBPACK_IMPORTED_MODULE_1__["Type"].withDefault(apiObject[Comment.ApiComments], []);
      comment.content = _Types_common__WEBPACK_IMPORTED_MODULE_1__["Type"].withDefault(apiObject[Comment.ApiContent], '');
      comment.contentRaw = _Types_common__WEBPACK_IMPORTED_MODULE_1__["Type"].withDefault(apiObject[Comment.ApiContentRaw], '');
      comment.depth = _Types_common__WEBPACK_IMPORTED_MODULE_1__["Type"].withDefault(apiObject[Comment.ApiDepth], 1);
      comment.descendents = _Types_common__WEBPACK_IMPORTED_MODULE_1__["Type"].withDefault(apiObject[Comment.ApiDescendents], []);
      comment.hasReplies = _Types_common__WEBPACK_IMPORTED_MODULE_1__["Type"].withDefault(apiObject[Comment.ApiHasReplies], false);
      comment.internalContentTruncated = _Types_common__WEBPACK_IMPORTED_MODULE_1__["Type"].withDefault(apiObject[Comment.ApiInternalContentTruncated], false);
      comment.isReply = _Types_common__WEBPACK_IMPORTED_MODULE_1__["Type"].withDefault(apiObject[Comment.ApiIsReply], false);
      comment.isParent = _Types_common__WEBPACK_IMPORTED_MODULE_1__["Type"].withDefault(apiObject[Comment.ApiIsParent], false);
      comment.isRoot = _Types_common__WEBPACK_IMPORTED_MODULE_1__["Type"].withDefault(apiObject[Comment.ApiIsRoot], true);
      comment.published = _Types_common__WEBPACK_IMPORTED_MODULE_1__["Type"].withDefault(apiObject[Comment.ApiPublished], false);
      comment.revisionCount = _Types_common__WEBPACK_IMPORTED_MODULE_1__["Type"].withDefault(apiObject[Comment.ApiRevisionCount], 0);
      comment.hasBeenCheckedForSpam = _Types_common__WEBPACK_IMPORTED_MODULE_1__["Type"].withDefault(apiObject[Comment.ApiHasCheckedForSpam], false);

      if (comment.hasBeenCheckedForSpam) {
        comment.isSpam = _Types_common__WEBPACK_IMPORTED_MODULE_1__["Type"].withDefault(apiObject[Comment.ApiSpam], true);
      } else {
        comment.isSpam = null;
      }
...
/***/ "./src/Data/Comments/commentCollection.js":
/*!************************************************!*\
  !*** ./src/Data/Comments/commentCollection.js ***!
  \************************************************/
/*! exports provided: default */
...
/* harmony import */ var _comment__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./comment */ "./src/Data/Comments/comment.js");
/* harmony import */ var _Types_type__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../../Types/type */ "./src/Types/type.js");
/* harmony import */ var _Concerns_providesCollectionInteractivity__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ../Concerns/providesCollectionInteractivity */ "./src/Data/Concerns/providesCollectionInteractivity.js");
...
var CommentCollection = /*#__PURE__*/function (_Array) {
  _inherits(CommentCollection, _Array);

  var _super = _createSuper(CommentCollection);

  function CommentCollection() {
    var _this;

    _classCallCheck(this, CommentCollection);

    _this = _super.call(this);
    Object(_Concerns_providesCollectionInteractivity__WEBPACK_IMPORTED_MODULE_18__["enforceCollectionType"])(_assertThisInitialized(_this), _Types_type__WEBPACK_IMPORTED_MODULE_17__["default"].typeOf(_comment__WEBPACK_IMPORTED_MODULE_16__["default"]));
    Object(_Concerns_providesCollectionInteractivity__WEBPACK_IMPORTED_MODULE_18__["applyCollectionSelectable"])(_assertThisInitialized(_this));
    Object(_Concerns_providesCollectionInteractivity__WEBPACK_IMPORTED_MODULE_18__["applyErrorState"])(_assertThisInitialized(_this));
    return _this;
  }
...
/* harmony default export */ __webpack_exports__["default"] = (CommentCollection);

/***/ }),

/***/ "./src/Data/Comments/index.js":
/*!************************************!*\
  !*** ./src/Data/Comments/index.js ***!
  \************************************/
...
/* harmony import */ var _author__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./author */ "./src/Data/Comments/author.js");
/* harmony import */ var _comment__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./comment */ "./src/Data/Comments/comment.js");
/* harmony import */ var _commentCollection__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./commentCollection */ "./src/Data/Comments/commentCollection.js");
/* harmony import */ var _threadContext__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./threadContext */ "./src/Data/Comments/threadContext.js");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
Comments.Author = _author__WEBPACK_IMPORTED_MODULE_0__["default"];
Comments.Comment = _comment__WEBPACK_IMPORTED_MODULE_1__["default"];
Comments.CommentCollection = _commentCollection__WEBPACK_IMPORTED_MODULE_2__["default"];
Comments.ThreadContext = _threadContext__WEBPACK_IMPORTED_MODULE_3__["default"];


/***/ }),

/***/ "./src/Data/Comments/searchOptions.js":
/*!********************************************!*\
  !*** ./src/Data/Comments/searchOptions.js ***!
  \********************************************/
/*! exports provided: default */
...
/***/ "./src/Data/Comments/threadContext.js":
/*!********************************************!*\
  !*** ./src/Data/Comments/threadContext.js ***!
  \********************************************/
/*! exports provided: default */
...
var ThreadContext = /*#__PURE__*/function () {
  function ThreadContext() {
    _classCallCheck(this, ThreadContext);
  ...
  _createClass(ThreadContext, null, [{
    key: "fromApiObject",
    value: function fromApiObject(apiObject) {
...
/* harmony default export */ __webpack_exports__["default"] = (ThreadContext);

/***/ }),

/***/ "./src/Data/Concerns/canBeSelected.js":
/*!********************************************!*\
  !*** ./src/Data/Concerns/canBeSelected.js ***!
  \********************************************/
/*! exports provided: canBeSelected */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "canBeSelected", function() { return canBeSelected; });
/* harmony import */ var core_js_modules_es_function_bind__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.function.bind */ "./node_modules/core-js/modules/es.function.bind.js");
/* harmony import */ var core_js_modules_es_function_bind__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_function_bind__WEBPACK_IMPORTED_MODULE_0__);

function canBeSelected(instance) {
...
/***/ "./src/Data/Concerns/providesCollectionInteractivity.js":
/*!**************************************************************!*\
  !*** ./src/Data/Concerns/providesCollectionInteractivity.js ***!
  \**************************************************************/
/*! exports provided: applyCollectionSelectable, applyErrorState, enforceCollectionType */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "applyCollectionSelectable", function() { return applyCollectionSelectable; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "applyErrorState", function() { return applyErrorState; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "enforceCollectionType", function() { return enforceCollectionType; });
/* harmony import */ var core_js_modules_es_function_bind__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.function.bind */ "./node_modules/core-js/modules/es.function.bind.js");
/* harmony import */ var core_js_modules_es_function_bind__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_function_bind__WEBPACK_IMPORTED_MODULE_0__);
...
function enforceCollectionType(instance, type) {
  ...
  instance.push = function (val) {
    ...
    throw new Error(this._outerType + ' expects type ' + this._typeEnforced + '. ' + val.constructor.name + ' provided');
  }.bind(instance);
}

/***/ }),

/***/ "./src/Data/Paged/common.js":
/*!**********************************!*\
  !*** ./src/Data/Paged/common.js ***!
  \**********************************/
/*! exports provided: PagedMetaData, RangeItem */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _pagedMetaData__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./pagedMetaData */ "./src/Data/Paged/pagedMetaData.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "PagedMetaData", function() { return _pagedMetaData__WEBPACK_IMPORTED_MODULE_0__["default"]; });

/* harmony import */ var _rangeItem__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./rangeItem */ "./src/Data/Paged/rangeItem.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "RangeItem", function() { return _rangeItem__WEBPACK_IMPORTED_MODULE_1__["default"]; });
...
/***/ "./src/Data/Paged/pagedMetaData.js":
/*!*****************************************!*\
  !*** ./src/Data/Paged/pagedMetaData.js ***!
  \*****************************************/
/*! exports provided: default */
...
var PagedMetaData = /*#__PURE__*/function () {
  function PagedMetaData() {
    _classCallCheck(this, PagedMetaData);
  ...
  _createClass(PagedMetaData, null, [{
    key: "fromApiObject",
    value: function fromApiObject(apiObject) {
      var newMetaData = new PagedMetaData();
      newMetaData.currentPage = _Types_type__WEBPACK_IMPORTED_MODULE_1__["default"].withDefault(apiObject[PagedMetaData.ApiCurrentPage], 1);
      newMetaData.totalPages = _Types_type__WEBPACK_IMPORTED_MODULE_1__["default"].withDefault(apiObject[PagedMetaData.ApiTotalPages], 1);
      newMetaData.totalItems = _Types_type__WEBPACK_IMPORTED_MODULE_1__["default"].withDefault(apiObject[PagedMetaData.ApiTotalItems], 1);
      newMetaData.itemsPerPage = _Types_type__WEBPACK_IMPORTED_MODULE_1__["default"].withDefault(apiObject[PagedMetaData.ApiItemsPerPage], 1);
      return newMetaData;
    }
  }]);
...
/* harmony default export */ __webpack_exports__["default"] = (PagedMetaData);

/***/ }),

/***/ "./src/Data/Paged/rangeItem.js":
/*!*************************************!*\
  !*** ./src/Data/Paged/rangeItem.js ***!
  \*************************************/
/*! exports provided: default */
...
var RangeItem = /*#__PURE__*/function () {
  ...
  _createClass(RangeItem, null, [{
    key: "makeSeparator",
    value: function makeSeparator() {
      var newItem = new RangeItem();
...
/* harmony default export */ __webpack_exports__["default"] = (RangeItem);
...
/*!***************************!*\
  !*** ./src/Data/index.js ***!
  \***************************/
/*! exports provided: Data, PagedMetaData */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Data", function() { return Data; });
/* harmony import */ var _Paged_pagedMetaData__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Paged/pagedMetaData */ "./src/Data/Paged/pagedMetaData.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "PagedMetaData", function() { return _Paged_pagedMetaData__WEBPACK_IMPORTED_MODULE_0__["default"]; });

/* harmony import */ var _Comments_index__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Comments/index */ "./src/Data/Comments/index.js");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
Data.Comments = _Comments_index__WEBPACK_IMPORTED_MODULE_1__["Comments"];
Data.PagedMetaData = _Paged_pagedMetaData__WEBPACK_IMPORTED_MODULE_0__["default"];
...
/* harmony default export */ __webpack_exports__["default"] = (BaseResponse);

/***/ }),

/***/ "./src/Http/Responses/commentResponse.js":
/*!***********************************************!*\
  !*** ./src/Http/Responses/commentResponse.js ***!
  \***********************************************/
/*! exports provided: default */
...
/* harmony import */ var _Data_Comments_threadContext__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../../Data/Comments/threadContext */ "./src/Data/Comments/threadContext.js");
...
/* harmony import */ var _Data_Comments_author__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../../Data/Comments/author */ "./src/Data/Comments/author.js");
...
var CommentResponse = /*#__PURE__*/function (_PagedResponse) {
  ...
  var _super = _createSuper(CommentResponse);
...
}(_pagedResponse__WEBPACK_IMPORTED_MODULE_17__["default"]);

/* harmony default export */ __webpack_exports__["default"] = (CommentResponse);

/***/ }),

/***/ "./src/Http/Responses/errorResponse.js":
/*!*********************************************!*\
  !*** ./src/Http/Responses/errorResponse.js ***!
  \*********************************************/
/*! exports provided: default */
...
/* harmony import */ var core_js_modules_web_dom_collections_iterator__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! core-js/modules/web.dom-collections.iterator */ "./node_modules/core-js/modules/web.dom-collections.iterator.js");
/* harmony import */ var core_js_modules_web_dom_collections_iterator__WEBPACK_IMPORTED_MODULE_13___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_iterator__WEBPACK_IMPORTED_MODULE_13__);
/* harmony import */ var _baseResponse__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./baseResponse */ "./src/Http/Responses/baseResponse.js");
...
var ErrorResponse = /*#__PURE__*/function (_BaseResponse) {
  _inherits(ErrorResponse, _BaseResponse);
...
}(_baseResponse__WEBPACK_IMPORTED_MODULE_14__["default"]);

/* harmony default export */ __webpack_exports__["default"] = (ErrorResponse);

/***/ }),

/***/ "./src/Http/Responses/pagedResponse.js":
/*!*********************************************!*\
  !*** ./src/Http/Responses/pagedResponse.js ***!
  \*********************************************/
/*! exports provided: default */
...
/* harmony import */ var _baseResponse__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./baseResponse */ "./src/Http/Responses/baseResponse.js");
...
var PagedResponse = /*#__PURE__*/function (_BaseResponse) {
  _inherits(PagedResponse, _BaseResponse);

  var _super = _createSuper(PagedResponse);
  ...
  function PagedResponse() {
    ...
    _this.hasPreviousPage = false;
    return _this;
  }

  return PagedResponse;
}(_baseResponse__WEBPACK_IMPORTED_MODULE_13__["default"]);

/* harmony default export */ __webpack_exports__["default"] = (PagedResponse);
...
/* harmony import */ var _Types_string__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../Types/string */ "./src/Types/string.js");
  ...
  _createClass(Client, [{
    ...
    value: function get(url, data) {
      if (typeof data !== 'undefined' && data !== null) {
        url = _Types_string__WEBPACK_IMPORTED_MODULE_5__["default"].format('{0}?{1}', url, this.urlEncode(data));
      }

      return new Promise(function (resolve, reject) {
        ky__WEBPACK_IMPORTED_MODULE_4__["default"].get(url).then(function (response) {
...
var Endpoints = /*#__PURE__*/function () {
  ...
  _createClass(Endpoints, null, [{
    ...
    value: function url(endpoint) {
      var baseUrl = _Types_string__WEBPACK_IMPORTED_MODULE_2__["default"].finish(_Config_environment__WEBPACK_IMPORTED_MODULE_1__["default"].STATAMIC_API_ROOT, '/');
...
Endpoints.SYSTEM_DETAILS = '';
Endpoints.COMMENTS_SEARCH = 'comments';
/* harmony default export */ __webpack_exports__["default"] = (Endpoints);

/***/ }),

/***/ "./src/Icons/comment.html":
/*!********************************!*\
  !*** ./src/Icons/comment.html ***!
  \********************************/
/*! no static exports found */
...
// Module
var code = "<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 16 16\">\r\n    <g fill=\"none\" stroke=\"currentColor\" stroke-linecap=\"round\" stroke-linejoin=\"round\" stroke-miterlimit=\"10\">\r\n        <circle cx=\"5.5\" cy=\"7.2\" r=\"1.8\"/>\r\n        <path d=\"M2.5 12.5c0-1.7 1.3-3 3-3s3 1.3 3 3h-6zM9.5 7.5h3M9.5 9.5h4\"/>\r\n        <path d=\"M14.5 3.5h-13c-.6 0-1 .4-1 1v10c0 .6.4 1 1 1h2c0-.6.4-1 1-1s1 .4 1 1h5c0-.6.4-1 1-1s1 .4 1 1h2c.6 0 1-.4 1-1v-10c0-.6-.4-1-1-1zM15.5 1.5c0-.6-.4-1-1-1h-13c-.6 0-1 .4-1 1\"/>\r\n    </g>\r\n</svg>";
// Exports
module.exports = code;
...
/* harmony import */ var core_js_modules_es_promise__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! core-js/modules/es.promise */ "./node_modules/core-js/modules/es.promise.js");
/* harmony import */ var core_js_modules_es_promise__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_promise__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _Http_endpoints__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../Http/endpoints */ "./src/Http/endpoints.js");
/* harmony import */ var _Http_client__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../Http/client */ "./src/Http/client.js");
/* harmony import */ var _Http_Responses_commentResponse__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../Http/Responses/commentResponse */ "./src/Http/Responses/commentResponse.js");
/* harmony import */ var _Http_Responses_errorResponse__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../Http/Responses/errorResponse */ "./src/Http/Responses/errorResponse.js");
/* harmony import */ var _Data_Comments_searchOptions__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../Data/Comments/searchOptions */ "./src/Data/Comments/searchOptions.js");
/* harmony import */ var _Types_type__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../Types/type */ "./src/Types/type.js");
...
var CommentRepository = /*#__PURE__*/function () {
  function CommentRepository() {
    ...
    this.client = new _Http_client__WEBPACK_IMPORTED_MODULE_5__["default"]();
  }

  _createClass(CommentRepository, [{
    key: "search",
    value: function search(options) {
      if (_Types_type__WEBPACK_IMPORTED_MODULE_9__["default"].hasValue(options) === false) {
        options = new _Data_Comments_searchOptions__WEBPACK_IMPORTED_MODULE_8__["default"]();
      }

      return new Promise(function (resolve, reject) {
        this.client.get(_Http_endpoints__WEBPACK_IMPORTED_MODULE_4__["default"].url(_Http_endpoints__WEBPACK_IMPORTED_MODULE_4__["default"].COMMENTS_SEARCH), options).then(function (result) {
          resolve(_Http_Responses_commentResponse__WEBPACK_IMPORTED_MODULE_6__["default"].fromApiResponse(result));
        })["catch"](function (e) {
          reject(_Http_Responses_errorResponse__WEBPACK_IMPORTED_MODULE_7__["default"].fromError(e));
        });
      }.bind(this));
    }
  }, {
    key: "unpublish",
    value: function unpublish(commentId) {}
  }, {
    key: "unpublishMany",
    value: function unpublishMany(commentIds) {}
  }, {
    key: "publish",
    value: function publish(commentId) {}
  }, {
    key: "publishMany",
    value: function publishMany(commentIds) {}
  }, {
    key: "update",
    ...
    key: "markManyAsSpam",
    value: function markManyAsSpam(commentIds) {}
  }, {
    key: "markAsNotSpam",
    value: function markAsNotSpam(commentId) {}
  }, {
    key: "markManyAsNotSpam",
    value: function markManyAsNotSpam(commentId) {}
  }]);

  return CommentRepository;
}();

/* harmony default export */ __webpack_exports__["default"] = (CommentRepository);

/***/ }),

/***/ "./src/Statamic/Hooks/blueprintHook.js":
/*!*********************************************!*\
  !*** ./src/Statamic/Hooks/blueprintHook.js ***!
  \*********************************************/
/*! exports provided: default */
...
/* harmony import */ var core_js_modules_es_object_define_property__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.object.define-property */ "./node_modules/core-js/modules/es.object.define-property.js");
/* harmony import */ var core_js_modules_es_object_define_property__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_object_define_property__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _Icons_comment_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../Icons/comment.html */ "./src/Icons/comment.html");
/* harmony import */ var _Icons_comment_html__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_Icons_comment_html__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _controlPanel__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../controlPanel */ "./src/Statamic/controlPanel.js");
...
var BlueprintHook = /*#__PURE__*/function () {
  function BlueprintHook() {
    _classCallCheck(this, BlueprintHook);
  }

  _createClass(BlueprintHook, null, [{
    key: "run",
    value: function run(app) {
      app.controlPanel.blueprints().addOtherEntry(_Icons_comment_html__WEBPACK_IMPORTED_MODULE_1___default.a, 'Meerkat Comments', _controlPanel__WEBPACK_IMPORTED_MODULE_2__["default"].cpUrl('meerkat/blueprint'));
    }
  }]);

  return BlueprintHook;
}();

/* harmony default export */ __webpack_exports__["default"] = (BlueprintHook);

/***/ }),

/***/ "./src/Statamic/blueprintEntry.html":
/*!******************************************!*\
  !*** ./src/Statamic/blueprintEntry.html ***!
  \******************************************/
/*! no static exports found */
...
// Module
var code = "<tr>\r\n    <td>\r\n        <div class=\"flex items-center\">\r\n            <div class=\"w-4 h-4 mr-2\">@svg</div>\r\n            <a href=\"@url\">@title</a>\r\n        </div>\r\n    </td>\r\n</tr>\r\n";
// Exports
module.exports = code;

/***/ }),

/***/ "./src/Statamic/blueprints.js":
/*!************************************!*\
  !*** ./src/Statamic/blueprints.js ***!
  \************************************/
/*! exports provided: default */
...
/* harmony import */ var _blueprintEntry_html__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./blueprintEntry.html */ "./src/Statamic/blueprintEntry.html");
/* harmony import */ var _blueprintEntry_html__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_blueprintEntry_html__WEBPACK_IMPORTED_MODULE_4__);
...
var Blueprints = /*#__PURE__*/function () {
  function Blueprints() {
    _classCallCheck(this, Blueprints);
  }

  _createClass(Blueprints, [{
    key: "addCollectionsEntry",
     ...
     * @param url
     */
    value: function addCollectionsEntry(svgIcon, title, url) {
      this.addTableEntry(this.getTable(Blueprints.TABLE_COLLECTIONS), svgIcon, title);
    }
    /**
    ...
    key: "addTaxonomiesEntry",
    value: function addTaxonomiesEntry(svgIcon, title, url) {
      this.addTableEntry(this.getTable(Blueprints.TABLE_TAXONOMIES), svgIcon, title);
    }
    /**
    ...
    key: "addGlobalsEntry",
    value: function addGlobalsEntry(svgIcon, title, url) {
      this.addTableEntry(this.getTable(Blueprints.TABLE_GLOBALS), svgIcon, title);
    }
    /**
    ...
    key: "addAssetContainersEntry",
    value: function addAssetContainersEntry(svgIcon, title, url) {
      this.addTableEntry(this.getTable(Blueprints.TABLE_CONTAINERS), svgIcon, title);
    }
    /**
    ...
    key: "addFormsEntry",
    value: function addFormsEntry(svgIcon, title, url) {
      this.addTableEntry(this.getTable(Blueprints.TABLE_FORMS), svgIcon, title);
    }
    /**
    ...
    key: "addTableEntry",
    value: function addTableEntry(table, svgIcon, title, url) {
      var newEntry = _blueprintEntry_html__WEBPACK_IMPORTED_MODULE_4___default.a;
      newEntry = newEntry.replace('@svg', svgIcon);
      newEntry = newEntry.replace('@title', title);
      newEntry = newEntry.replace('@url', url);
      window.jQuery(table).find('tbody').append(window.jQuery(newEntry));
    }
  }]);
...
/* harmony default export */ __webpack_exports__["default"] = (Blueprints);

/***/ }),

/***/ "./src/Statamic/controlPanel.js":
/*!**************************************!*\
  !*** ./src/Statamic/controlPanel.js ***!
  \**************************************/
/*! exports provided: default */
...
/* harmony import */ var core_js_modules_es_object_define_property__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_object_define_property__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _Config_environment__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../Config/environment */ "./src/Config/environment.js");
/* harmony import */ var _blueprints__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./blueprints */ "./src/Statamic/blueprints.js");
...
var ControlPanel = /*#__PURE__*/function () {
  function ControlPanel() {
    ...
    this._blueprints = new _blueprints__WEBPACK_IMPORTED_MODULE_2__["default"]();
  }
  ...
  _createClass(ControlPanel, [{
    ...
    key: "cpUrl",
    value: function cpUrl(path) {
      return _Config_environment__WEBPACK_IMPORTED_MODULE_1__["default"].STATAMIC_CP_ROOT + path;
    }
  }]);
...
/***/ "./src/Statamic/statamicTranslator.js":
/*!********************************************!*\
  !*** ./src/Statamic/statamicTranslator.js ***!
  \********************************************/
/*! exports provided: default */
...
/* harmony import */ var core_js_modules_web_dom_collections_iterator__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! core-js/modules/web.dom-collections.iterator */ "./node_modules/core-js/modules/web.dom-collections.iterator.js");
/* harmony import */ var core_js_modules_web_dom_collections_iterator__WEBPACK_IMPORTED_MODULE_13___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_iterator__WEBPACK_IMPORTED_MODULE_13__);
/* harmony import */ var _Translation_translator__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../Translation/translator */ "./src/Translation/translator.js");
/* harmony import */ var _Types_string__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../Types/string */ "./src/Types/string.js");
/* harmony import */ var addon__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! addon */ "./src/addon.js");
...
var StatamicTranslator = /*#__PURE__*/function (_Translator) {
  _inherits(StatamicTranslator, _Translator);

  var _super = _createSuper(StatamicTranslator);

  function StatamicTranslator() {
    _classCallCheck(this, StatamicTranslator);

    return _super.apply(this, arguments);
  }

  _createClass(StatamicTranslator, [{
    key: "translate",
    value: function translate(val) {
      return window.__(_Types_string__WEBPACK_IMPORTED_MODULE_15__["default"].format('{0}::{1}', addon__WEBPACK_IMPORTED_MODULE_16__["default"].codeAddonName, val));
    }
  }]);

  return StatamicTranslator;
}(_Translation_translator__WEBPACK_IMPORTED_MODULE_14__["default"]);

/* harmony default export */ __webpack_exports__["default"] = (StatamicTranslator);
...
/*!*****************************!*\
  !*** ./src/Types/common.js ***!
  \*****************************/
/*! exports provided: Convert, Guid, Range, String, Type, Url */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _convert__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./convert */ "./src/Types/convert.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Convert", function() { return _convert__WEBPACK_IMPORTED_MODULE_0__["default"]; });

/* harmony import */ var _guid__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./guid */ "./src/Types/guid.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Guid", function() { return _guid__WEBPACK_IMPORTED_MODULE_1__["default"]; });

/* harmony import */ var _range__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./range */ "./src/Types/range.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Range", function() { return _range__WEBPACK_IMPORTED_MODULE_2__["default"]; });

/* harmony import */ var _string__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./string */ "./src/Types/string.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "String", function() { return _string__WEBPACK_IMPORTED_MODULE_3__["default"]; });

/* harmony import */ var _type__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./type */ "./src/Types/type.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Type", function() { return _type__WEBPACK_IMPORTED_MODULE_4__["default"]; });

/* harmony import */ var _url__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./url */ "./src/Types/url.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Url", function() { return _url__WEBPACK_IMPORTED_MODULE_5__["default"]; });
...
/* harmony import */ var _guid__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./guid */ "./src/Types/guid.js");
/* harmony import */ var _string__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./string */ "./src/Types/string.js");
/* harmony import */ var _url__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./url */ "./src/Types/url.js");
/* harmony import */ var _range__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./range */ "./src/Types/range.js");
/* harmony import */ var _convert__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./convert */ "./src/Types/convert.js");
/* harmony import */ var _type__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./type */ "./src/Types/type.js");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
Types.Convert = _convert__WEBPACK_IMPORTED_MODULE_4__["default"];
Types.Guid = _guid__WEBPACK_IMPORTED_MODULE_0__["default"];
Types.String = _string__WEBPACK_IMPORTED_MODULE_1__["default"];
Types.Range = _range__WEBPACK_IMPORTED_MODULE_3__["default"];
Types.Type = _type__WEBPACK_IMPORTED_MODULE_5__["default"];
Types.Url = _url__WEBPACK_IMPORTED_MODULE_2__["default"];
...
// TODO: Need to validate these return types at a later date.
var jQuery = /*#__PURE__*/function () {
  ...
  _createClass(jQuery, [{
    ...
    key: "init",
    value: function init(selector, context, root) {}
  }, {
    key: "has",
    value: function has(target) {}
  }, {
    key: "closest",
    value: function closest(selectors, context) {}
  }, {
    key: "index",
    ...
    key: "addBack",
    value: function addBack(selector) {}
  }, {
    key: "parent",
    value: function parent(until, selector) {}
  }, {
    key: "parents",
    value: function parents(until, selector) {}
  }, {
    key: "parentsUntil",
    value: function parentsUntil(until, selector) {}
  }, {
    key: "next",
    value: function next(until, selector) {}
  }, {
    key: "prev",
    value: function prev(until, selector) {}
  }, {
    key: "nextAll",
    value: function nextAll(until, selector) {}
  }, {
    key: "prevAll",
    value: function prevAll(until, selector) {}
  }, {
    key: "nextUntil",
    value: function nextUntil(until, selector) {}
  }, {
    key: "prevUntil",
    value: function prevUntil(until, selector) {}
  }, {
    key: "siblings",
    value: function siblings(until, selector) {}
  }, {
    key: "children",
    value: function children(until, selector) {}
  }, {
    key: "contents",
    value: function contents(until, selector) {}
  }, {
    key: "ready",
    ...
    key: "queue",
    value: function queue(type, data) {}
  }, {
    key: "dequeue",
    value: function dequeue(type) {}
  }, {
    key: "clearQueue",
    value: function clearQueue(type) {}
  }, {
    key: "promise",
    value: function promise(type, obj) {}
  }, {
    key: "show",
    value: function show(speed, easing, callback) {}
  }, {
    key: "hide",
    value: function hide(speed, easing, callback) {}
  }, {
    key: "toggle",
    value: function toggle(speed, easing, callback) {}
  }, {
    key: "on",
    value: function on(types, selector, data, fn) {}
  }, {
    key: "one",
    value: function one(types, selector, data, fn) {}
  }, {
    key: "off",
    value: function off(types, selector, fn) {}
  }, {
    key: "detach",
    value: function detach(selector) {}
  }, {
    key: "remove",
    ...
    key: "clone",
    value: function clone(dataAndEvents, deepDataAndEvents) {}
  }, {
    key: "html",
    ...
    key: "fadeTo",
    value: function fadeTo(speed, to, easing, callback) {}
  }, {
    key: "animate",
    value: function animate(prop, speed, easing, callback) {}
  }, {
    key: "stop",
    value: function stop(type, clearQueue, gotoEnd) {}
  }, {
    key: "finish",
    value: function finish(type) {}
  }, {
    key: "slideDown",
    value: function slideDown(speed, easing, callback) {}
  }, {
    key: "slideUp",
    value: function slideUp(speed, easing, callback) {}
  }, {
    key: "slideToggle",
    value: function slideToggle(speed, easing, callback) {}
  }, {
    key: "fadeIn",
    value: function fadeIn(speed, easing, callback) {}
  }, {
    key: "fadeOut",
    value: function fadeOut(speed, easing, callback) {}
  }, {
    key: "fadeToggle",
    value: function fadeToggle(speed, easing, callback) {}
  }, {
    key: "delay",
    value: function delay(time, type) {}
  }, {
    key: "attr",
    ...
    key: "triggerHandler",
    value: function triggerHandler(type, data) {}
  }, {
    key: "serialize",
    ...
    key: "unwrap",
    value: function unwrap(selector) {}
  }, {
    key: "load",
    value: function load(url, params, callback) {}
  }, {
    key: "offset",
    value: function offset(options) {}
  }, {
    key: "position",
    ...
    key: "innerHeight",
    value: function innerHeight(margin, value) {}
  }, {
    key: "height",
    value: function height(margin, value) {}
  }, {
    key: "outerHeight",
    value: function outerHeight(margin, value) {}
  }, {
    key: "innerWidth",
    value: function innerWidth(margin, value) {}
  }, {
    key: "width",
    value: function width(margin, value) {}
  }, {
    key: "outerWidth",
    value: function outerWidth(margin, value) {}
  }, {
    key: "ajaxStart",
    value: function ajaxStart(fn) {}
  }, {
    key: "ajaxStop",
    value: function ajaxStop(fn) {}
  }, {
    key: "ajaxComplete",
    value: function ajaxComplete(fn) {}
  }, {
    key: "ajaxError",
    value: function ajaxError(fn) {}
  }, {
    key: "ajaxSuccess",
    value: function ajaxSuccess(fn) {}
  }, {
    key: "ajaxSend",
    value: function ajaxSend(fn) {}
  }, {
    key: "bind",
    value: function bind(types, data, fn) {}
  }, {
    key: "unbind",
    value: function unbind(types, fn) {}
  }, {
    key: "delegate",
    value: function delegate(selector, types, data, fn) {}
  }, {
    key: "undelegate",
    value: function undelegate(selector, types, fn) {}
  }, {
    key: "hover",
    value: function hover(fnOver, fnOut) {}
  }, {
    key: "blur",
    value: function blur(data, fn) {}
  }, {
    key: "focus",
    value: function focus(data, fn) {}
  }, {
    key: "focusin",
    value: function focusin(data, fn) {}
  }, {
    key: "focusout",
    value: function focusout(data, fn) {}
  }, {
    key: "resize",
    value: function resize(data, fn) {}
  }, {
    key: "scroll",
    value: function scroll(data, fn) {}
  }, {
    key: "click",
    value: function click(data, fn) {}
  }, {
    key: "dblclick",
    value: function dblclick(data, fn) {}
  }, {
    key: "mousedown",
    value: function mousedown(data, fn) {}
  }, {
    key: "mouseup",
    value: function mouseup(data, fn) {}
  }, {
    key: "mousemove",
    value: function mousemove(data, fn) {}
  }, {
    key: "mouseover",
    value: function mouseover(data, fn) {}
  }, {
    key: "mouseout",
    value: function mouseout(data, fn) {}
  }, {
    key: "mouseenter",
    value: function mouseenter(data, fn) {}
  }, {
    key: "mouseleave",
    value: function mouseleave(data, fn) {}
  }, {
    key: "change",
    value: function change(data, fn) {}
  }, {
    key: "select",
    value: function select(data, fn) {}
  }, {
    key: "submit",
    value: function submit(data, fn) {}
  }, {
    key: "keydown",
    value: function keydown(data, fn) {}
  }, {
    key: "keypress",
    value: function keypress(data, fn) {}
  }, {
    key: "keyup",
    value: function keyup(data, fn) {}
  }, {
    key: "contextmenu",
    value: function contextmenu(data, fn) {}
  }]);
...
var Range = /*#__PURE__*/function () {
  ...
  _createClass(Range, null, [{
     ...
     */
    value: function get(min, max, step) {
      step = _type__WEBPACK_IMPORTED_MODULE_1__["default"].withDefault(step, 1);
      var range = [];
  ...
  _createClass(String, null, [{
    ...
    value: function format(value) {
      ...
      for (var i = 0; i < (arguments.length <= 1 ? 0 : arguments.length - 1); i++) {
        var replacement = '{' + i + '}';
        content = content.replace(replacement, i + 1 < 1 || arguments.length <= i + 1 ? undefined : arguments[i + 1]);
      }
  ...
  _createClass(Type, null, [{
    ...
    value: function typeOf(type) {
      ...
      if (_typeof(type.prototype) !== 'object') {
        if (_typeof(type.__proto__) === 'object') {
    ...
    key: "withDefault",
    value: function withDefault(value, defaultValue) {
...
var Url = /*#__PURE__*/function () {
  ...
  _createClass(Url, null, [{
    key: "toAbsolute",
    value: function toAbsolute(base, relative) {
...
/*!**********************!*\
  !*** ./src/hooks.js ***!
  \**********************/
/*! exports provided: controlPanelHooks */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "controlPanelHooks", function() { return controlPanelHooks; });
/* harmony import */ var _Statamic_Hooks_blueprintHook__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Statamic/Hooks/blueprintHook */ "./src/Statamic/Hooks/blueprintHook.js");

var controlPanelHooks = [{
  'path': /^(.*?)\/fields\/blueprints(.*?)$/,
  'uses': _Statamic_Hooks_blueprintHook__WEBPACK_IMPORTED_MODULE_0__["default"]
}];
