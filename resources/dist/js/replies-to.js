...
(function () {
  var MeerkatReply = {
    ...
    getOpenReplyForm: function getOpenReplyForm() {
  ...
  var MeerkatForms = {
    ...
    findClosest: function findClosest(el, selector) {
      var matchesFn;
    ...
    findElementWithClass: function findElementWithClass(node, classRegex) {
      var matches = [];
    ...
    getReplyForm: function getReplyForm() {
      ...
      if (form.length > 0) {
        ...
        if (meerkatReplyForm.innerHTML.indexOf('h-captcha') > -1) {
          ...
          var captchaElements = this.findElementWithClass(meerkatReplyForm, '\s*h-captcha\s*');

          if (typeof captchaElements !== 'undefined' && captchaElements.length > 0) {
            var captchaEle = captchaElements[0];
            ...
            if (typeof captchaEle.dataset !== 'undefined') {
              var captchaDataSet = captchaEle.dataset;
          ...
          if (typeof window['grecaptcha'] !== 'undefined') {
            ...
            var _captchaElements = this.findElementWithClass(meerkatReplyForm, '\s*g-recaptcha\s*');

            if (typeof _captchaElements !== 'undefined' && _captchaElements.length > 0) {
              var _captchaEle = _captchaElements[0];
              this.data.CaptchaElementId = 'meerkat_c-' + this.generateId();

              _captchaEle.setAttribute('id', this.data.CaptchaElementId);

              if (typeof _captchaEle.dataset !== 'undefined') {
                var _captchaDataSet = _captchaEle.dataset;

                if (typeof _captchaDataSet.sitekey !== 'undefined') {
                  this.data.GoogleRecaptchaSiteKey = _captchaDataSet.sitekey;
                }

                if (typeof _captchaDataSet.theme !== 'undefined') {
                  this.data.GoogleRecaptchaTheme = _captchaDataSet.theme;
                } else {
    ...
    makeReplyInput: function makeReplyInput(replyingTo) {
    ...
    replyHandler: function replyHandler(event) {
    ...
    addCancelReplyListeners: function addCancelReplyListeners() {
      var _this = this,
