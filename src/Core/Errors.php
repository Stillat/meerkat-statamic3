...
class Errors
{
    ...
    const COMMENT_PARSER_NODE_FAILURE = '04-004';

    const COMMENT_PARSER_ID_INTEGRITY_LOST = '04-005';
    ...
    const MISSING_PERMISSION_SYS_ADMIN = '05-009';

    const MISSING_PERMISSION_NON_CODE_CONFIG = '05-010';
    ...
    const CONFIG_MISSING_PARAMETERS = '09-001';
}
